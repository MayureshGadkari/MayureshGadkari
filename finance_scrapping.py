...
# Open Finviz login page
    ...
    engine = create_engine('sqlite:///finviz_data.db')
    df.to_sql('stocks_every_5min', con=engine, if_exists='append', index=False)
    driver.quit()

schedule.every().day.at("07:00").do(scrap_daily)
